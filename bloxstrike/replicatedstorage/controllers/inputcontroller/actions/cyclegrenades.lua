...
local v_u4 = require(v_replicatedstorage.Components.Common.UserInput.EquipInventorySlot)
return table.freeze({
	["Name"] = "Cycle Grenades",
	["Group"] = "Gameplay",
	["Category"] = "Weapon Keys",
	["Callback"] = function(arg1, _)
		-- upvalues: (copy) v_u_localplayer, (copy) v_u2, (copy) v_u3, (copy) v_u1, (copy) v_u4
